...
Verified on AMD64 and ARM64 in [runtime workflow 36012352984](https://github.com/hakopod/hakopod/actions/runs/36012352984) using named disposable Hakopod development clusters. An authenticated database/document round trip succeeds, and the document survives a pod restart on the same claim. Owned fixture claims and dynamic volumes were reclaimed after the test.
