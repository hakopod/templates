...
Verified on AMD64 and ARM64 in [runtime workflow 36012352984](https://github.com/hakopod/hakopod/actions/runs/36012352984) using named disposable Hakopod development clusters. PostgreSQL and the application reach readiness. A marker in the attachments directory survives a pod restart on the same claim. Owned fixture claims and dynamic volumes were reclaimed after the test.
